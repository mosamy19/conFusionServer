...
var JwtStratigy = require('passport-jwt').Strategy;
...
exports.jwtPassport = passport.use(new JwtStratigy(opts, 
    (jwt_payload, done) => {
...
exports.FacebookTokenStrategy = passport.use(new FacebookTokenStrategy({
    ...
    clientSecret: "319c57abfab073fd19aa96dd91fd15db" //config.facebbok.clientSecret
